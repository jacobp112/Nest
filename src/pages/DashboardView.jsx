    ...
    <div className="min-h-screen bg-surface">
      ...
      >
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div>
            <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.2em] text-primary">Nest Finance</p>
            <h1 className="text-xl sm:text-2xl font-semibold text-text-primary">Secure Financial Command Center</h1>
          </div>
        ...
        <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex flex-wrap items-center gap-3">
            <div
              className={card({
                padding: 'none',
                className: 'inline-flex items-center gap-2 rounded-full border border-border/70 px-2 sm:px-3 py-1 text-[10px] sm:text-xs font-medium text-text-secondary shadow-none',
              })}
            >
              <button
            ...
            <select
              className="rounded-full border border-border bg-surface px-2 sm:px-3 py-1 sm:py-1.5 text-[10px] sm:text-xs font-semibold text-text-secondary transition hover:border-primary/70 hover:text-text-primary"
              value={datePreset}
            ...
            {datePreset === 'custom' ? (
              <div className="flex flex-wrap items-center gap-2 text-[10px] sm:text-xs text-text-secondary">
                ...
                <button
                  ...
                  className={`rounded-full px-3 py-1 text-xs font-semibold transition ${customDateDraft.start && customDateDraft.end
          ...
          <div className="flex flex-wrap items-center gap-2">
            <select
              className="rounded-pill border border-border bg-surface px-2 sm:px-3 py-1 sm:py-1.5 text-[10px] sm:text-xs font-semibold text-text-secondary transition hover:border-primary hover:text-text-primary"
              value={accountFilter}
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <section className={card({ className: 'lg:col-span-3' })}>
            <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.3em] text-primary">At-a-Glance</p>
                <h2 className="mt-2 text-lg sm:text-xl font-semibold text-text-primary">Today's financial pulse</h2>
              </div>
              <p className="text-[10px] sm:text-xs text-text-muted">Snapshot prototype - Placeholder values</p>
            </div>
            <div className="grid gap-4 md:grid-cols-3">
              <div
                className={card({ variant: 'muted', padding: 'md', className: 'space-y-3 shadow-none' })}
              >
                <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-wide text-text-secondary">Safe to Spend</p>
                <p className="mt-3 text-2xl sm:text-3xl font-semibold text-text-primary">
                  <StatSafeToSpend userDoc={userDoc} dateRange={dateRange} />
                </p>
                <p className="mt-1 text-[10px] sm:text-xs text-text-muted">After upcoming bills & goals.</p>
              </div>
              <div className={card({ padding: 'md', className: 'space-y-3' })}>
                <div className="flex items-start justify-between">
                  <div>
                    <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-wide text-text-secondary">Net Worth</p>
                    <p className="mt-3 text-2xl sm:text-3xl font-semibold text-text-primary"><StatNetWorthValue /></p>
                  </div>
                  <span className="rounded-full bg-emerald-50 px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs font-semibold text-emerald-700">
              ...
              <div className={card({ padding: 'md', className: 'space-y-3' })}>
                <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-wide text-text-secondary">Monthly Budget</p>
                <div className="mt-3 flex items-baseline gap-2">
                  <p className="text-2xl sm:text-3xl font-semibold text-text-primary"><StatBudgetProgress dateRange={dateRange} /></p>
                  <span className="text-[10px] sm:text-xs font-semibold uppercase tracking-wide text-primary">60% full</span>
                </div>
          ...
          <section className={card({ padding: 'lg' })}>
            <div className="flex items-center justify-between">
              <h2 className="text-base sm:text-lg font-semibold text-text-primary">Spending by Category (D3)</h2>
              <p className="text-xs sm:text-sm text-text-secondary">Theme-aware via CSS variables</p>
            </div>
            <div className="mt-4">
          ...
          <section className={card({ padding: 'lg' })}>
            <h2 className="text-base sm:text-lg font-semibold text-text-primary">Net Worth (3D)</h2>
            <p className="text-xs sm:text-sm text-text-secondary">GPU-accelerated bars; updates without full re-render</p>
            <div className="mt-4">
          ...
          <section className={card({ padding: 'lg' })}>
            <div className="flex items-center justify-between">
              <h2 className="text-base sm:text-lg font-semibold text-text-primary">Spending Relationships (D3 Force)</h2>
              <p className="text-xs sm:text-sm text-text-secondary">Simulation runs in a Web Worker</p>
            </div>
          ...
          <section
            className="relative overflow-hidden rounded-3xl border border-emerald-100/60 bg-gradient-to-br from-emerald-600 via-emerald-500 to-emerald-700 p-4 sm:p-6 md:p-8 text-emerald-50 shadow-2xl lg:col-span-2"
          >
            <div className="pointer-events-none absolute inset-0 opacity-80">
              <div className="absolute -left-16 top-16 h-32 w-32 sm:h-40 sm:w-40 rounded-full bg-surface opacity-20 blur-3xl" />
              <div className="absolute -right-12 bottom-0 h-36 w-36 sm:h-48 sm:w-48 rounded-full bg-emerald-300/30 blur-3xl" />
            </div>
            <div className="relative z-10 flex flex-col gap-4 sm:gap-6 md:gap-8 md:flex-row md:items-center md:justify-between">
              <div className="max-w-xl space-y-3 sm:space-y-4">
                <div className="inline-flex items-center gap-2 rounded-full bg-surface bg-opacity-10 px-3 py-1.5 sm:px-4 sm:py-2 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.3em] text-emerald-100">
                  <Sparkles className="h-3 sm:h-4 w-3 sm:w-4" />
                  Personalized briefing
                </div>
                <div>
                  <h2 className="text-2xl sm:text-3xl font-semibold">Welcome back, {greetingName}</h2>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className={`subtle-chip text-left text-xs sm:text-sm text-emerald-50/90`}>
                  <p className="text-[10px] sm:text-xs font-medium uppercase tracking-wide text-emerald-100/80">Net monthly position</p>
                  <p className="mt-1 text-xl sm:text-2xl font-semibold text-white">{formatCurrency(totals.net)}</p>
                  <p className="mt-1 flex items-center gap-2 text-[10px] sm:text-xs text-emerald-100/70">
                    <ArrowUpRight className="h-3 sm:h-3.5 w-3 sm:w-3.5" />
                    {monthlySavings > 0
                ...
                <div className={`subtle-chip text-left text-xs sm:text-sm text-emerald-50/90`}>
                  <p className="text-[10px] sm:text-xs font-medium uppercase tracking-wide text-emerald-100/80">Manual entries - {rangeLabel}</p>
                  <p className="mt-1 text-xl sm:text-2xl font-semibold text-white">{manualEntryCount}</p>
                  <p className="mt-1 flex items-center gap-2 text-[10px] sm:text-xs text-emerald-100/70">
                    <BarChart3 className="h-3 sm:h-3.5 w-3 sm:w-3.5" />
                    {manualEntryCount === 0 ? 'Add new transactions' : 'Real-time analytics enabled'}
                  </p>
                </div>
                <div className={`subtle-chip text-left text-xs sm:text-sm text-emerald-50/90`}>
                  <p className="text-[10px] sm:text-xs font-medium uppercase tracking-wide text-emerald-100/80">Recurring income</p>
                  <p className="mt-1 text-xl sm:text-2xl font-semibold text-white">{formatCurrency(userDoc?.recurringIncome || 0)}</p>
                  <p className="mt-1 flex items-center gap-2 text-[10px] sm:text-xs text-emerald-100/70">
                ...
                <div className={`subtle-chip text-left text-xs sm:text-sm text-emerald-50/90`}>
                  <p className="text-[10px] sm:text-xs font-medium uppercase tracking-wide text-emerald-100/80">Goals momentum</p>
                  <p className="mt-1 text-xl sm:text-2xl font-semibold text-white">{goals.length}</p>
                  <p className="mt-1 flex items-center gap-2 text-[10px] sm:text-xs text-emerald-100/70">
                    <PiggyBank className="h-3 sm:h-3.5 w-3 sm:w-3.5" />
                    {goals.length === 0
            ...
            {shouldShowChecklist && (
              ...
              >
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.3em] text-emerald-300">Next steps</p>
                    <h3 className="mt-2 text-lg sm:text-xl font-semibold text-white">Make the most of your new data</h3>
          ...
          {hasLinkedAccounts && (
            ...
            >
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div>
                  <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.3em] text-emerald-300">Live linked balances</p>
                  <h3 className="mt-2 text-xl sm:text-2xl font-semibold text-white">{formatCurrency(totalLinkedBalance)}</h3>
                  <p className="mt-2 text-xs sm:text-sm text-text-muted">
          ...
          {shouldShowFirstTransactionPrompt && (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold">Add your first expense</h3>
                  <p className="mt-2 text-xs sm:text-sm text-emerald-900/80">
            ...
            {insightCards.map((insight) => (
              ...
              >
                ...
                <div className="relative z-10 space-y-3">
                  <div className="flex items-center justify-between">
                    <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.3em] text-emerald-600">{insight.title}</p>
                    <ArrowUpRight className={`h-3 sm:h-4 w-3 sm:w-4 ${insight.accent ? 'text-emerald-500' : 'text-text-muted'}`} />
                  </div>
                  <p className="text-xl sm:text-2xl font-semibold text-text-primary">{insight.value}</p>
                  <p className="text-[10px] sm:text-xs text-text-muted">{insight.caption}</p>
                </div>
              </button>
            ))}
          </section>
          ...
          <section className={card({ className: 'lg:col-span-2' })}>
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h2 className="text-base sm:text-lg font-semibold text-text-primary">Cash Flow Waterfall</h2>
                <p className="text-xs sm:text-sm text-text-secondary">Follow how income funds top categories before landing in savings.</p>
              </div>
          ...
          <section className={card({ className: 'lg:col-span-1' })}>
            <div className="flex items-start justify-between">
              <div>
                <h2 className="text-base sm:text-lg font-semibold text-text-primary">Cash Flow Calendar</h2>
                <p className="text-xs sm:text-sm text-text-secondary">A high-level glance at expected inflows and bills this month.</p>
              </div>
                    ...
                    >
                      ...
                      <div className="mt-1 space-y-1">
                        {cell.markers.slice(0, 2).map((marker) => (
                          <div
                            key={marker.key}
                            className={`flex items-center gap-1 rounded-full px-1.5 py-0.5 text-[10px] ${marker.type === 'income'
          ...
          <section className={quickAddSectionClasses}>
            <h2 className="text-base sm:text-lg font-semibold text-text-primary">Quick add entries</h2>
            <p className="mt-1 text-xs sm:text-sm text-text-secondary">Capture income and expenses instantly to keep your dashboard current.</p>
          ...
          <section className={card({ className: 'lg:col-span-1' })}>
            <h2 className="text-base sm:text-lg font-semibold text-text-primary">Savings goals</h2>
            <p className="mt-1 text-xs sm:text-sm text-text-secondary">Align your monthly savings with meaningful milestones.</p>
          ...
          <section className={card({ className: 'lg:col-span-2' })}>
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h2 className="text-base sm:text-lg font-semibold text-text-primary">Spending Trends (This Month vs. Last Month)</h2>
                <p className="text-xs sm:text-sm text-text-secondary">Spot the categories with the biggest month-over-month shifts.</p>
              </div>
            </div>
            <div className="mt-6 h-72">
          ...
          <section className={card({ className: 'lg:col-span-1' })}>
            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <h2 className="text-base sm:text-lg font-semibold text-text-primary">AI Insights Engine</h2>
          ...
          <section className={card({ className: 'lg:col-span-2' })}>
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h2 className="text-base sm:text-lg font-semibold text-text-primary">Investment projection</h2>
                <p className="text-xs sm:text-sm text-text-secondary">
          ...
          <section className={card({ className: 'lg:col-span-1' })}>
            <div className="flex items-start justify-between">
              <div>
                <h2 className="text-base sm:text-lg font-semibold text-text-primary">Net Worth Trend</h2>
                <p className="text-xs sm:text-sm text-text-secondary">See how assets and liabilities stack up over time.</p>
              </div>
              {!isPremium ? (
          ...
          <section className={card({ className: 'lg:col-span-3' })}>
            <div className="flex flex-wrap items-center justify-between gap-3">
              <h2 className="text-base sm:text-lg font-semibold text-text-primary">Transactions - {rangeLabel}</h2>
                    ...
                    {drilldown.metrics ? (
                      <div className="grid gap-3 sm:grid-cols-3">
                        ...
                        <div className="rounded-xl border border-emerald-100 bg-emerald-50 p-3">
                          ...
                          <p
                            className={`mt-1 text-lg font-semibold ${drilldown.metrics.delta >= 0 ? 'text-emerald-700' : 'text-red-600'
                              }`}
                          >
