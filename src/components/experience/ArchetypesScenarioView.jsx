...
const LabelOverlay = ({ title, subtitle, icon: Icon, align = 'left' }) => (
    ...
    >
        ...
        <p className="text-xs sm:text-sm font-medium text-slate-400 uppercase tracking-widest">{subtitle}</p>
    </motion.div>
);
        ...
        <div className="h-full w-full relative bg-slate-950 overflow-hidden flex flex-col items-center justify-center font-sans perspective-1000">
            ...
            <AnimatePresence>
                {step === 'intro' && (
                    ...
                    >
                        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-white tracking-tighter mb-4">
                            Four roles.
                        </h1>
                        <p className="text-lg sm:text-xl text-slate-400 font-light tracking-[0.2em] uppercase">
            ...
            <motion.div
                className={`w-full max-w-5xl transition-all duration-700 ease-[cubic-bezier(0.25,0.8,0.25,1)] ${isGrid
                        ? 'grid grid-cols-2 gap-3 sm:gap-4 px-4 sm:px-8 h-[80%]'
            ...
            <AnimatePresence>
                ...
                {step === 'message' && (
                    ...
                    >
                        ...
                        <h2 className="text-3xl sm:text-4xl font-bold text-white text-center mb-2">Nest adapts to you.</h2>
                        <p className="text-lg sm:text-xl text-slate-300">Not the other way around.</p>
                    </motion.div>
                )}
                {step === 'outro' && (
                    <motion.div
                    ...
                    >
                        ...
                        >
                            ...
                            <h1 className="text-4xl sm:text-5xl font-bold text-white tracking-tighter mb-4">Nest</h1>
                            <p className="text-xs sm:text-sm text-slate-400 uppercase tracking-widest">Your household. Your roles. Your journey.</p>
                        </motion.div>
                    </motion.div>
                )}
            </AnimatePresence>
